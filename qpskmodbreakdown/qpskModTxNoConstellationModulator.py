...
# Title: qpskModTxNoConstellationModulator
...
class qpskModTxNoConstellationModulator(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModTxNoConstellationModulator", catch_exceptions=True)
...
def main(top_block_cls=qpskModTxNoConstellationModulator, options=None):
    tb = top_block_cls()
