...
class qpskModRxNoCostasLoop(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModRxNoCostasLoop", catch_exceptions=True)
        ...
        # Blocks
        ##################################################
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_probe_rate_0, 0))
...
def main(top_block_cls=qpskModRxNoCostasLoop, options=None):
    tb = top_block_cls()
