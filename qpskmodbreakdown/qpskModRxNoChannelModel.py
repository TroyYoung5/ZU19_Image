...
class qpskModRxNoChannelModel(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModRxNoChannelModel", catch_exceptions=True)
...
def main(top_block_cls=qpskModRxNoChannelModel, options=None):
    tb = top_block_cls()
