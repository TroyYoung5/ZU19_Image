...
# Title: qpskModRxNoPolyphaseClockSync
...
class qpskModRxNoPolyphaseClockSync(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModRxNoPolyphaseClockSync", catch_exceptions=True)
...
def main(top_block_cls=qpskModRxNoPolyphaseClockSync, options=None):
    tb = top_block_cls()
