...
class qpskModRxNoConversion(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModRxNoConversion", catch_exceptions=True)
...
def main(top_block_cls=qpskModRxNoConversion, options=None):
    tb = top_block_cls()
