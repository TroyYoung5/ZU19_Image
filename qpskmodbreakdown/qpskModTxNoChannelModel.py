...
class qpskModTxNoChannelModel(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "qpskModTxNoChannelModel", catch_exceptions=True)
...
def main(top_block_cls=qpskModTxNoChannelModel, options=None):
    tb = top_block_cls()
