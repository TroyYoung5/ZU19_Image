...
class SDR_to_SDR_BPSK_CONTROL_AND_DISPLAY(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SDR_to_SDR_BPSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SDR_to_SDR_BPSK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDR_to_SDR_BPSK_CONTROL_AND_DISPLAY")
        ...
        self.zeromq_sub_source_0_0_2_0 = zeromq.sub_source(gr.sizeof_float, 1, 'tcp://127.0.0.1:10005', 100, False, (-1), '', False)
        self.zeromq_sub_source_0_0_2 = zeromq.sub_source(gr.sizeof_float, 1, 'tcp://127.0.0.1:10004', 100, False, (-1), '', False)
        self.zeromq_sub_source_0_0_1 = zeromq.sub_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:10003', 100, False, (-1), '', False)
        self.zeromq_sub_source_0_0_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:10002', 100, False, (-1), '', False)
        self.zeromq_sub_source_0_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:10001', 100, False, (-1), '', False)
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:10000', 100, False, (-1), '', False)
        self.xmlrpc_client_0_0 = ServerProxy('http://'+'localhost'+':8000')
        self.xmlrpc_client_0 = ServerProxy('http://'+'localhost'+':8000')
        self._tx_gain_range = Range(0, 31.5, 0.5, 0, 200)
        ...
        self._rx_gain_range = Range(0, 31.5, 0.5, 10, 200)
        ...
        self.qtgui_time_sink_x_3_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Reconstructed Bits Post CAC", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_3_0_win, 2, 4, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_3_win, 2, 2, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_1_win, 0, 1, 2, 1)
        for r in range(0, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "After Constellation Modulator", #name
            1,
            None # parent
        )
        ...
        self.qtgui_const_sink_x_1 = qtgui.const_sink_c(
            1024, #size
            "Reconstructed Constellation", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_win, 0, 2, 2, 1)
        for r in range(0, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/dev/null', False)
        ...
        self.connect((self.zeromq_sub_source_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.zeromq_sub_source_0, 0), (self.qtgui_time_sink_x_1_1, 0))
        self.connect((self.zeromq_sub_source_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.zeromq_sub_source_0_0_0, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.zeromq_sub_source_0_0_1, 0), (self.blocks_file_sink_1, 0))
        self.connect((self.zeromq_sub_source_0_0_2, 0), (self.qtgui_time_sink_x_3, 0))
        self.connect((self.zeromq_sub_source_0_0_2_0, 0), (self.qtgui_time_sink_x_3_0, 0))
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.xmlrpc_client_0_0.set_tx_gain(self.tx_gain)
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.xmlrpc_client_0.set_rx_gain(self.rx_gain)




def main(top_block_cls=SDR_to_SDR_BPSK_CONTROL_AND_DISPLAY, options=None):
