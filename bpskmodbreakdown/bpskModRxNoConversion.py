...
class bpskModRxNoConversion(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModRxNoConversion", catch_exceptions=True)
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_probe_rate_0, 0))
...
def main(top_block_cls=bpskModRxNoConversion, options=None):
    tb = top_block_cls()
