...
class bpskModRxNoChannelModel(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModRxNoChannelModel", catch_exceptions=True)
...
def main(top_block_cls=bpskModRxNoChannelModel, options=None):
    tb = top_block_cls()
