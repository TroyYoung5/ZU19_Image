...
class bpskModTxNoChannelModel(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModTxNoChannelModel", catch_exceptions=True)
...
def main(top_block_cls=bpskModTxNoChannelModel, options=None):
    tb = top_block_cls()
