...
class bpskModRx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModRx", catch_exceptions=True)
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_probe_rate_0, 0))
...
def main(top_block_cls=bpskModRx, options=None):
    tb = top_block_cls()
