...
class bpskModRxNoCostasLoop(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModRxNoCostasLoop", catch_exceptions=True)
...
def main(top_block_cls=bpskModRxNoCostasLoop, options=None):
    tb = top_block_cls()
