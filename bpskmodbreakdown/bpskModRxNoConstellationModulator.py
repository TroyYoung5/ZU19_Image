...
# Title: bpskModRxNoConstellationModulator
...
class bpskModRxNoConstellationModulator(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "bpskModRxNoConstellationModulator", catch_exceptions=True)
...
def main(top_block_cls=bpskModRxNoConstellationModulator, options=None):
    tb = top_block_cls()
